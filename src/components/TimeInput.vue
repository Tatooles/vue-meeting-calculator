...
<template>
  ...
  <div class="mb-6 flex h-2/5 justify-center">
    <input
      ...
      type="text"
      placeholder="HH"
      class="mr-6 w-1/3 border-2 border-black bg-inherit text-center text-4xl dark:border-white"
    />
    <input
      v-model="minutes"
      @input="validateNumber"
      type="text"
      placeholder="MM"
      class="w-1/3 border-2 border-black bg-inherit text-center text-4xl dark:border-white"
    />
  </div>
