...
<template>
  ...
  <div class="flex justify-around">
    <button
      @click="setTimer"
      class="w-full border-x-2 border-t-2 border-black dark:border-white"
  ...
  <div
    class="flex h-60 flex-col items-center justify-center border-2 border-t-0 border-black dark:border-white"
  >
